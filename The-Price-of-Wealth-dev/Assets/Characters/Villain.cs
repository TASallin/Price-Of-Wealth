public class Villain : Character {
	...
	public TimedMethod[] Knife () {
		...
		return new TimedMethod[] {new TimedMethod(30, "Log", new object[] {"The Megalomaniac used the knife"}),
	...
	public TimedMethod[] Pistol () {
		...
		return new TimedMethod[] {new TimedMethod(30, "Log", new object[] {"The Megalomaniac shot the pistol"}),
	...
	public TimedMethod[] Acid () {
		...
		return new TimedMethod[] {new TimedMethod(30, "Log", new object[] {"The Megalomaniac threw an acid bomb"}),
		    new TimedMethod(0, "Audio", new object[] {"Missile"}), new TimedMethod(0, "AudioAfter", new object[] {"S Explosion", 30}),
	    	new TimedMethod(0, "AttackAll", new object[] {false, 2, 2, GetAccuracy(), true})};
	}
	
	public TimedMethod[] Steroid () {
		GainPower(3);
		return new TimedMethod[] {new TimedMethod(0, "Audio", new object[] {"Knife"}),
		    new TimedMethod(30, "Log", new object[] {"The Megalomaniac applied steroids"}),
	...
	public TimedMethod[] Poison() {
		...
		return new TimedMethod[] {new TimedMethod(0, "Audio", new object[] {"Fumes"}),
		    new TimedMethod(30, "Log", new object[] {"The Megalomaniac sprayed poison fumes"}), poisonPart[0], poisonPart[1]};
	}
	...
	public TimedMethod[] Smoke() {
		...
		return new TimedMethod[] {new TimedMethod(0, "AudioAfter", new object[] {"S Explosion", 20}),
		    new TimedMethod(30, "Log", new object[] {"The Megalomaniac threw a smoke bomb"}), blindPart[0], blindPart[1], evadePart};
	}
	...
	public TimedMethod[] Duel() {
		...
		return new TimedMethod[] {new TimedMethod(0, "Audio", new object[] {"Poison"}),
		    new TimedMethod(30, "Log", new object[] {"The Megalomaniac gave an insulting taunt. Evasion halved"}),
	...
	public TimedMethod[] Drug() {
		if (Attacks.EvasionCycle(this, Party.GetEnemy())) {
			...
			return new TimedMethod[] {new TimedMethod(0, "AudioAfter", new object[] {"Knife", 15}), new TimedMethod(30, "Log", new object[] {
			...
			return new TimedMethod[] {new TimedMethod(0, "Audio", new object[] {"Small Swing"}),
    			new TimedMethod(30, "Log", new object[] {"The Megalomaniac missed with an unstable formula"})};
		}
	}
	...
	public TimedMethod[] Hypnotize() {
	    if (Attacks.EvasionCycle(GetAccuracy() * 2, Party.GetPlayer())) {
			...
			return new TimedMethod[] {new TimedMethod(0, "Audio", new object[] {"Possession"}),
			    new TimedMethod(120, "Log", new object[] {"The Megalomaniac activated the evil device"}), 
	...
	public TimedMethod[] Switch() {
		if (GetGooped()) {
			...
			return new TimedMethod[] {new TimedMethod(0, "Audio", new object[] {"S Explosion"}),
			    new TimedMethod(30, "Log", new object[] {"The Megalomaniac escaped the goop with a smoke bomb"}),
