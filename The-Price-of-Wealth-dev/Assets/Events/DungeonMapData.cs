...
public static class DungeonMapData {
	...
	public static void Initialize () {
		...
		Dictionary<string, AdjacencyList> tutContents = new Dictionary<string, AdjacencyList>();
		tutContents.Add("Tut1", new AdjacencyList("Tut1", new string[] {"Tut2"}));
		tutContents.Add("Tut2", new AdjacencyList("Tut2", new string[] {"Tut1", "Tut3"}));
		tutContents.Add("Tut3", new AdjacencyList("Tut3", new string[] {"Tut2", "Tut4"}));
		tutContents.Add("Tut4", new AdjacencyList("Tut4", new string[] {"Tut3", "Tut5"}));
		tutContents.Add("Tut5", new AdjacencyList("Tut5", new string[] {"Tut4"}));
		Dictionary<string, Event> tutEvents = new Dictionary<string, Event>();
		TutorialGetter.Refresh();
		tutEvents.Add("Tut1", TutorialGetter.One());
	    tutEvents.Add("Tut2", TutorialGetter.Two());
		tutEvents.Add("Tut3", TutorialGetter.Three());
		tutEvents.Add("Tut4", TutorialGetter.Four());
		tutEvents.Add("Tut5", TutorialGetter.Five());
		DungeonMap tutorial = new DungeonMap("Tut1", tutContents, tutEvents);
